  ...
  private heroes: Heroe[] = [
    ...
    },
    {
      ...
      bio: 'Los rasgos principales de Batman se resumen en «destreza física, habilidades deductivas y obsesión».' +
        ...
        ' interpretaciones que le han dado al personaje.',
    ...
    },
    {
      ...
      bio: 'Al haber perdido la vista, los cuatro sentidos restantes de Daredevil fueron aumentados' +
        ...
        ' de su ceguera, puede "ver" a través de un "sexto sentido" que le sirve como un radar similar' +
        ' al de los murciélagos.',
    ...
    },
    {
      ...
      bio: 'Poseedor del anillo de poder que posee la capacidad de crear manifestaciones de luz ' +
        ...
        'por escritores posteriores como un poder místico llamado Starheart), una llama mágica contenida ' +
        'en dentro de un orbe (el orbe era en realidad un meteorito verde de metal que cayó a la Tierra, ' +
    ...
    },
    {
      ...
      bio: 'En el universo ficticio de Marvel, Wolverine posee poderes regenerativos que pueden' +
        ...
        ' inmune a cualquier enfermedad existente en la Tierra y algunas extraterrestres . ' +
        'Posee también una fuerza sobrehumana, que si bien no se compara con la de otros ' +
        'superhéroes como Hulk, sí sobrepasa la de cualquier humano.',
